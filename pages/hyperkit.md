...
- [[Docker Desktop on Mac]] creates a VM to host containers:
	- ```console
...
- Breaking down a hyperkit invocation:
	- ```
	  com.docker.hyperkit \
	    ...
	    -s 2:0,virtio-blk,/Users/jtigger/Library/Containers/com.docker.docker/Data/vms/0/data/Docker.raw \  # disk
